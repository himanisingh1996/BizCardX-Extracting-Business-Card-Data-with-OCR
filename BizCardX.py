...
# Title
st.title(':green[Business Card Data Extraction]')
...
with tab1:
    ...
    # --------------------------------------   /   Data Upload to Mysql   /   --------------------------------------- #
        ...
        if session_state.data_uploaded:
            ...
            engine = create_engine('mysql+mysqlconnector://root:123456@localhost/bizcard_db', echo=False)
...
with tab2:
    ...
    with col2:
        ...
        try:
            ...
            st.info('No data stored in the database or there is some error in database connection.')
