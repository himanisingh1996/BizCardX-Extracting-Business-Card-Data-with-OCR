...
def set_page_config():
    st.set_page_config(
        ...
        menu_items={'About': """# This OCR app is created by *himani singh*!"""}
    )
...
def setting_bg():
    st.markdown(
        ...
        <style>
            .stApp {
               # background: url("https://cdn.pixabay.com/photo/2015/12/01/15/43/GREY-1072366_1280.jpg");
...
if selected == 'Profile':
    ...
    with col1:
        ...
        st.markdown("### :gray[Name:  ] :blue[himani singh]")
        st.markdown("### :violet[My Project GitHub link] ⬇️")
        github_url = "https://github.com/himanisingh1996/BizCardX-Extracting-Business-Card-Data-with-OCR"
        button_color = "#781734"
